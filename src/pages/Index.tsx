...
const Index = () => {
  return (
    <main className="redlab-shell min-h-screen overflow-hidden text-foreground">
      <header className="glass-nav fixed left-0 right-0 top-0 z-30">
        <nav className="mx-auto flex h-20 max-w-7xl items-center justify-between px-5 sm:px-6">
          <a href="#home" className="leading-none" aria-label="Binapani Narratives home">
            <div className="redlab-kicker text-base">
              <span>Binapani </span>
          ...
          <div className="hidden items-center gap-4 md:flex">
            ...
            <a href="#enroll" className="redlab-button flex items-center gap-3 rounded-md px-5 py-4 text-sm font-black italic uppercase">
      ...
      <section id="home" className="relative flex min-h-screen items-center justify-center px-5 pb-14 pt-28 text-center">
        <div className="mx-auto max-w-6xl animate-fade-in">
          <div className="redlab-pill mx-auto mb-8 inline-flex items-center gap-3 rounded-full px-5 py-2 text-xs font-black uppercase tracking-[0.24em]">
          ...
          <p className="redlab-kicker hero-bio mx-auto mt-9 max-w-5xl text-sm leading-7 md:text-base md:leading-8">
          ...
          <div className="mx-auto mt-16 flex max-w-3xl justify-center">
            <div className="redlab-stat redlab-stat-blur flex items-center justify-center px-10">
      ...
      <section id="courses" className="redlab-section-band px-5 py-24">
        <div className="mx-auto max-w-7xl">
          <p className="redlab-kicker">The Binapani Narratives Philosophy</p>
        </div>
      </section>
    </main>
  );
